...
public class WanderingFightersConfig {
    ...
    public static ForgeConfigSpec.DoubleValue DAMAGE_ATTRIBUTE_ADDITION;
    public static ForgeConfigSpec.DoubleValue HEALTH_ATTRIBUTE_MULTIPLICATION;
    ...
    private static void setupConfig(ForgeConfigSpec.Builder builder) {
        ...
        DAMAGE_ATTRIBUTE_ADDITION = builder.defineInRange("fighter_damage", 12.0, 0, Double.MAX_VALUE);
        builder.comment("Specify the health boost a Wandering Trader gets after being hurt");
        HEALTH_ATTRIBUTE_MULTIPLICATION = builder.defineInRange("fighter_health", 12.5, 0, Double.MAX_VALUE);
    }
}
